    ...
    <footer className="bg-gray-800 text-white mt-auto">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">Synergence Portal</h3>
            <p className="text-gray-400 mb-4">
              Streamlining manufacturing operations with role-based dashboards for optimal efficiency.
            </p>
          </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-sm text-gray-400 flex flex-col md:flex-row justify-between items-center">
          <p>© 2025 Synergence Portal. All rights reserved.</p>
          <p className="mt-4 md:mt-0">Designed and developed by Your Team</p>
        </div>
      </div>
    </footer>
  );
